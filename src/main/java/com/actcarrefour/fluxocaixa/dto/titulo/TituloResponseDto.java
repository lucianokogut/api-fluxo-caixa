...
public class TituloResponseDto {
    ...
    private List<CentroCustoResponseDto> centrosCustos;
    ...
    public List<CentroCustoResponseDto> getcentrosCustos() {
        return centrosCustos;
    }

    public void setcentrosCustos(List<CentroCustoResponseDto> centrosCustos) {
