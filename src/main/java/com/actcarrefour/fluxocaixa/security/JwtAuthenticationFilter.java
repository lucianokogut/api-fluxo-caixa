...
import com.actcarrefour.fluxocaixa.dto.usuario.LoginRequestDto;
import com.actcarrefour.fluxocaixa.dto.usuario.LoginResponseDto;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        usuarioResponse.setObservacao(usuario.getObservacao());
        ...
        loginResponseDto.setToken("H@sh " + token);
